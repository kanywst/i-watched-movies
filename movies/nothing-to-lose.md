...
tags:
  ...
  - 'Action'
national: 'USA'
cover_image: 'https://image.tmdb.org/t/p/original/umbzQyRMeB1oHTKiymTlH591xNB.jpg'
...
The two circle from mutual hatred to a working partnership, robbing a convenience store and then setting up the real job: emptying the safe in Barrow's own office. Two rival criminals, Rig and Charlie, are working the same neighborhood and do not appreciate the competition, and a security guard named Davis keeps turning up between them and the money.
